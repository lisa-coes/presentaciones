---
title: "Taller Flujo UC Enero 2026"
...
.left[
![:scale 50%](datasoc_red1.png)

<br>
![:scale 50%](logo-lisa.png)
<br>
...
.right[
.content-box-gray[
 ## **.red[Protocolos y buenas prácticas para códigos y datos abiertos]**
----
...
.small[.right[**Seminario _Abre tu Ciencia_, UC Enero 2026**]
]]
...
.pull-left-narrow[
<br>
![:scale 90%](datasoc_red1.png)

<br>

![:scale 90%](logo-lisa.png)
...
.pull-right-wide[
####Data.red[SOC] es un Centro de Datos Sociales de la Facultad de Ciencias Sociales de la Universidad de Chile, orientado a posicionarse como un referente en el análisis, procesamiento, gestión y transferencia de datos sociales, en un marco de ciencia abierta, y guiado por altos estándares conceptuales, metodológicos y éticos.
...
---
### Día 1 del génesis de la reproducibilidad:

.pull-left-narrow[_
<br>
"Al principio Dios vio un excel lleno de colores..."_]
...
---
.center[
![:scale 50%](https://lisacoes.com/protocolos/a-ipo-rep/ipo-hex.png)
]
...
## [https://lisacoes.com/protocolos/a-ipo-rep/](https://lisacoes.com/protocolos/a-ipo-rep/)
...
- La escritura en téxto plano permite la ejecución de **documentos dinámicos**

- Los documentos dinámicos integran **distintas formas de código** (de escritura y análisis)

- Se evita la práctica no reproducible de **cortar/pegar**

- Mayor **eficiencia** al momento de corregir y ejecutar los análisis

- Ejemplos: knitr, RMarkdown, Quarto

---
class: roja, middle, center

.content-box-red[
# .red[Donde hay cortar/pegar, no hay reproducibilidad 
]]
---
## Referencias en texto plano

- Escenciales en trabajo académico, y una de las barreras para escritura académica en texto plano / documentos dinámicos 

- Requiere base de referencias en texto plano -> **BibTex**

- Exportación a BibTex disponible en la mayor parte de los gestores de referencias

- Pero ... 

---
![](https://data-soc.github.io/workshop-reproducibilidad/workshop/images/bibtex-ej.png)

---
class: center middle

![:scale 100%](zotero-bib.png)
...
- recomendación actual: VSC (Visual Studio Code) 
]]
...
[https://lisacoes.com/](https://lisacoes.com/) 

[https://github.com/lisa-coes](https://github.com/lisa-coes)

![:scale 20%](octocat.png) 
---
